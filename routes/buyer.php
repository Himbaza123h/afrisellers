...
Route::prefix('buyer')->name('buyer.')->group(function () {
    ...
    Route::prefix('compare')->name('compare.')->group(function () {
        Route::get('/',                              [\App\Http\Controllers\Buyer\ProductCompareController::class, 'index'])->name('index');
        Route::post('/add/{product}',               [\App\Http\Controllers\Buyer\ProductCompareController::class, 'add'])->name('add');
        Route::delete('/remove/{product}',          [\App\Http\Controllers\Buyer\ProductCompareController::class, 'remove'])->name('remove');
        Route::delete('/clear',                     [\App\Http\Controllers\Buyer\ProductCompareController::class, 'clear'])->name('clear');
    });
        // Dashboard
        Route::get('/dashboard', [DashboardController::class, 'index'])->name('dashboard.home');


        Route::post('/become-vendor/extra-document', [BuyerController::class, 'uploadExtraDocument'])
    ->name('become-vendor.extra-document');
        ...
        // Become Agent Routes
        Route::get('/become-agent', [BuyerController::class, 'showBecomeAgent'])->name('become-agent');
        Route::post('/become-agent', [BuyerController::class, 'storeBecomeAgent'])->name('become-agent.store');
