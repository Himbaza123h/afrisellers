...
use App\Http\Controllers\Vendor\AdController;
...
Route::prefix('vendor')
    ...
    ->group(function () {
        ...
        ->name('articles.')
        // ->middleware('vendor.feature:has_brand_storytelling')
        ->group(function () {
        Route::get('/', [ArticleController::class, 'index'])->name('index');
        Route::get('/print', [ArticleController::class, 'print'])->name('print');
        ...
        Route::prefix('ads')->name('ads.')->middleware('vendor.feature:can_has_ads')->group(function () {
...
Route::get('/dashboard/print', [VendorDashboardController::class, 'print'])
    ->name('dashboard.print');
        ...
        Route::prefix('promo-codes')->name('promo-code.')->middleware('vendor.feature:can_has_ads')->group(function () {
        ...
        Route::prefix('rfqs')
            ->name('rfq.')
            ->middleware('vendor.feature:has_rfq_access')
            ->group(function () {
    ...
    Route::delete('/{advertisement}',   [AdvertisementController::class, 'destroy'])->name('destroy');
            ...
            Route::prefix('reports')
                ->name('reports.')
                ->middleware('vendor.feature:has_performance_reports')
                ->group(function () {
            ...
            Route::prefix('performance')
                ->name('performance.')
                ->middleware('vendor.feature:has_analytics')
                ->group(function () {
...
Route::prefix('showrooms')->name('showrooms.')->middleware('vendor.feature:has_company_page')->group(function () {
    Route::get('/', [VendorShowroomController::class, 'index'])->name('index');
        ...
        Route::prefix('store')
            ...
            ->group(function () {
                ...
                Route::get('/settings/print', [VendorProfileController::class, 'printSettings'])->name('settings.print');
            });
...
// Subscription/Plan Routes
        Route::prefix('subscription')
            ...
            ->group(function () {
                ...
                Route::get('/{subscription}/plan-pdf', [SubscriptionController::class, 'planPdf'])->name('vendor.subscriptions.plan-pdf');
                Route::post('/subscribe/{plan}', [SubscriptionController::class, 'subscribe'])->name('subscribe');
                Route::post('/renew', [SubscriptionController::class, 'renew'])->name('renew');
                Route::post('/toggle-auto-renew', [SubscriptionController::class, 'toggleAutoRenew'])->name('toggle-auto-renew');
                Route::get('/{subscription}/invoice', [SubscriptionController::class, 'invoice'])->name('invoice');
