...
use App\Http\Controllers\Regional\AgentController;
...
Route::prefix('regional')->name('regional.')->middleware(['auth'])->group(function () {
 ...
 Route::prefix('agents')->name('agents.')->group(function () {
    ...
    Route::get('/print',      [AgentController::class, 'print'])->name('print');
    Route::get('/{id}',       [AgentController::class, 'show'])->name('show');
    Route::post('/{id}/suspend',  [AgentController::class, 'suspend'])->name('suspend');
    Route::post('/{id}/activate', [AgentController::class, 'activate'])->name('activate');
});
