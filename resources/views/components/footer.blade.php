<footer class="bg-gray-900 text-gray-400">
    <div class="container mx-auto px-4 py-16">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12 mb-12">
            ...
            <!-- For Buyers -->
            <div>
                <h3 class="text-white font-semibold text-sm mb-4 uppercase tracking-wider">For Buyers</h3>
                <ul class="space-y-3 text-sm">
                    <li><a href="#" class="hover:text-white transition-colors">Post RFQ</a></li>
                    <li><a href="#" class="hover:text-white transition-colors">Browse Suppliers</a></li>
                    <li><a href="#" class="hover:text-white transition-colors">Product Categories</a></li>
                    <li><a href="#" class="hover:text-white transition-colors">Buyer Protection</a></li>
                    <li><a href="#" class="hover:text-white transition-colors">Trade Assurance</a></li>
                </ul>
            </div>

            <!-- For Suppliers -->
            <div>
                <h3 class="text-white font-semibold text-sm mb-4 uppercase tracking-wider">For Suppliers</h3>
                <ul class="space-y-3 text-sm">
                    <li><a href="#" class="hover:text-white transition-colors">Start Selling</a></li>
                    <li><a href="#" class="hover:text-white transition-colors">Membership Plans</a></li>
                    <li><a href="#" class="hover:text-white transition-colors">Seller Resources</a></li>
                    <li><a href="#" class="hover:text-white transition-colors">Success Stories</a></li>
                    <li><a href="#" class="hover:text-white transition-colors">Advertising</a></li>
                </ul>
            </div>

            <!-- Support -->
            <div>
                <h3 class="text-white font-semibold text-sm mb-4 uppercase tracking-wider">Support</h3>
                <ul class="space-y-3 text-sm">
                    <li><a href="#" class="hover:text-white transition-colors">Help Center</a></li>
                    <li><a href="#" class="hover:text-white transition-colors">Contact Us</a></li>
                    <li><a href="#" class="hover:text-white transition-colors">Terms & Conditions</a></li>
                    <li><a href="#" class="hover:text-white transition-colors">Privacy Policy</a></li>
                    <li><a href="#" class="hover:text-white transition-colors">Safety & Security</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="border-t border-gray-800 pt-8 pb-8">
            <div class="flex flex-col md:flex-row justify-between items-center gap-6">
                <div class="text-sm">
                    <p class="text-gray-500 mb-2">Secure Payment Methods</p>
                    <div class="flex gap-3">
                        ...
                        <div class="bg-white px-3 py-2 rounded">
                            <svg class="h-6" viewBox="0 0 48 24" fill="none">
                                <rect width="48" height="24" rx="3" fill="#fff"/>
                ...
                <div class="text-sm text-center md:text-right">
                    <p class="text-gray-500 mb-2">Trusted By</p>
                    <div class="flex items-center gap-4">
                        <div class="bg-gray-800 px-4 py-2 rounded text-xs text-gray-400">
                            <span class="font-semibold">50,000+</span> Suppliers
                        </div>
                        <div class="bg-gray-800 px-4 py-2 rounded text-xs text-gray-400">
                            <span class="font-semibold">100,000+</span> Buyers
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="border-t border-gray-800 pt-8">
            <div class="flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
                <p class="text-gray-500">© {{ date('Y') }} AfriSellers. All rights reserved.</p>
