    ...
    <div class="container mx-auto px-4 py-16">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 lg:gap-12 mb-12">
            ...
            <div class="lg:col-span-2">
                ...
                <p class="text-sm leading-relaxed mb-6">{{ __('messages.footer_about') }}</p>
            ...
            <!-- For Buyers -->
            <div>
                <h3 class="text-white font-semibold text-sm mb-4 uppercase tracking-wider">{{ __('messages.footer_for_buyers') }}</h3>
                <ul class="space-y-3 text-sm">
                    <li><a href="#" class="hover:text-white transition-colors">{{ __('messages.footer_post_rfq') }}</a></li>
                    <li><a href="#" class="hover:text-white transition-colors">{{ __('messages.footer_browse_suppliers') }}</a></li>
            ...
            <!-- Shipping Brand -->
            <div>
                <h3 class="text-white font-semibold text-sm mb-4 uppercase tracking-wider">{{ __('Shipping Brands') }}</h3>
                <ul class="space-y-3 text-sm">
            ...
            <!-- For Suppliers -->
            <div>
                <h3 class="text-white font-semibold text-sm mb-4 uppercase tracking-wider">{{ __('messages.footer_for_suppliers') }}</h3>
                <ul class="space-y-3 text-sm">
            ...
            <!-- Support -->
            <div>
                <h3 class="text-white font-semibold text-sm mb-4 uppercase tracking-wider">{{ __('messages.footer_support') }}</h3>
                <ul class="space-y-3 text-sm">
        ...
        <div class="border-t border-gray-800 pt-8 pb-8">
            <div class="flex flex-col md:flex-row justify-between items-center gap-6">
                <div class="text-sm">
                    <p class="text-gray-500 mb-2">{{ __('messages.footer_secure_payment') }}</p>
                ...
                <div class="text-sm text-center md:text-right">
                    <p class="text-gray-500 mb-2">{{ __('messages.footer_trusted_by') }}</p>
        ...
        <div class="border-t border-gray-800 pt-8">
            <div class="flex flex-col md:flex-row justify-between items-center gap-4 text-sm">
                <p class="text-gray-500">© {{ date('Y') }} AfriSellers. {{ __('messages.footer_rights_reserved') }}</p>
