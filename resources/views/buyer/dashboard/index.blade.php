...
@section('content')
    <div class="min-h-screen bg-gray-50">
        ...
        $productImage = $firstItem->product
            ? ($firstItem->product->images->where('is_primary', true)->first()
    ...
    @endphp
                    ...
                    @else
                        <div class="py-8 text-center">
                            ...
                            <a href="{{ route('home') }}" class="inline-block mt-3 text-xs font-bold text-[#ff0808] hover:underline">
