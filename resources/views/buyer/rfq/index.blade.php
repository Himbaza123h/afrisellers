                            ...
                            <div class="flex flex-wrap gap-2 justify-between items-start pb-3 mb-3 border-b border-gray-100 sm:gap-3">
                                <div class="flex-1 min-w-0">
                                    <div class="flex flex-wrap gap-2 items-center mb-1">
                                        ...
                                        @if($rfq->tracking === 'delivered')
                                            <span class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[9px] sm:text-xs font-bold bg-blue-100 text-blue-700">
                                                <i class="fas fa-check-double text-[8px]"></i> Delivered
                                            </span>
                                        @elseif($rfq->tracking === 'read')
                                            <span class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[9px] sm:text-xs font-bold bg-purple-100 text-purple-700">
                                                <i class="fas fa-eye text-[8px]"></i> Read
                                            </span>
                                        @elseif($rfq->tracking === 'sent')
                                            <span class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[9px] sm:text-xs font-bold bg-gray-100 text-gray-500">
