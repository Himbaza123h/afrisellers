...
@if(session('success'))
    <div class="p-3 mb-4 bg-green-50 rounded-lg border border-green-200 flex items-start gap-2">
...
<div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
    ...
    <div class="lg:col-span-2 space-y-4">
                ...
                <form action="{{ route('profile.update') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div>
                            ...
                            <input type="text"
                                   ...
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#ff0808] focus:border-transparent text-sm"
                                   required>
                            @error('name')
                    ...
                    @if($user->buyer)
                        ...
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2 mt-4">
                            <div>
                                <label for="phone_code" class="block text-xs font-medium text-gray-700 mb-1">Phone Code</label>
                                <input type="text"
                                       name="phone_code"
                                       id="phone_code"
                        ...
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2 mt-4">
                            <div>
                                <label for="country_id" class="block text-xs font-medium text-gray-700 mb-1">Country</label>
                        ...
                        <div class="grid grid-cols-1 gap-4 md:grid-cols-2 mt-4">
                            ...
                            <div>
                                <label for="sex" class="block text-xs font-medium text-gray-700 mb-1">Gender</label>
                    ...
                    <div class="mt-4">
                        <button type="submit"
                                class="px-3 py-2 bg-[#ff0808] text-white font-semibold rounded-lg hover:bg-red-700 transition-colors text-sm">
                            Update Profile
                        </button>
                    </div>
                </form>
        ...
        <div class="bg-white rounded-lg border border-gray-200 shadow-sm">
            ...
            <div class="p-4">
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <div>
                        <label class="block text-xs font-medium text-gray-700 mb-1">Email Verified</label>
                        <div class="mt-1">
                            @if($user->email_verified_at)
                                <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
                                    <i class="mr-1 fas fa-check-circle" style="font-size: 8px;"></i>Verified
                                </span>
                            @else
                                <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">
                                    <i class="mr-1 fas fa-clock" style="font-size: 8px;"></i>Not Verified
                                </span>
                            @endif
                        </div>
                    </div>
        ...
        @if($user->isVendor() && $user->vendor)
            ...
            <div class="bg-white rounded-lg border border-gray-200 shadow-sm">
                <div class="px-4 py-3 border-b border-gray-200">
                    <h2 class="text-base font-bold text-gray-900">Vendor Information</h2>
                </div>
                <div class="p-4">
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        ...
                        @if($user->vendor->plan)
                            <div>
                                <label class="block text-xs font-medium text-gray-700 mb-1">Current Plan</label>
        ...
        @if($user->buyer)
            ...
            <div class="bg-white rounded-lg border border-gray-200 shadow-sm">
                <div class="px-4 py-3 border-b border-gray-200">
                    <h2 class="text-base font-bold text-gray-900">Buyer Information</h2>
                </div>
                <div class="p-4">
                    <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div>
    ...
    <div class="space-y-4">
        ...
        <div class="bg-white rounded-lg border border-gray-200 shadow-sm">
            <div class="p-4 text-center">
                ...
                @endphp
                <img src="https://ui-avatars.com/api/?name={{ urlencode($userName) }}&background={{ $roleColor }}&color=fff&bold=true&size=96"
                     alt="{{ $userName }}"
                     class="w-20 h-20 mx-auto rounded-full ring-4 ring-gray-100 mb-3">
