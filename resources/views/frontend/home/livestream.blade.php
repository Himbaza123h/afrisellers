                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden">
                    ...
                    <div class="p-3 sm:p-4 md:p-6">
                        ...
                        <div class="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-gray-50 rounded-lg mb-4">
                            <div class="w-12 h-12 sm:w-16 sm:h-16 bg-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white text-lg sm:text-2xl font-bold flex-shrink-0">
                                T
                            </div>
            ...
            <div class="lg:col-span-1 space-y-4 sm:space-y-6">
                ...
                <div id="live-chat-section" class="bg-white rounded-lg shadow-lg overflow-hidden hidden lg:block">
                    ...
                    <div class="h-80 sm:h-96 overflow-y-auto p-3 sm:p-4 space-y-2 sm:space-y-3 bg-gray-50 custom-scrollbar" id="chat-messages">
                        ...
                        <div class="flex gap-2">
                            <div class="w-7 h-7 sm:w-8 sm:h-8 bg-blue-500 to-purple-600 rounded-full flex items-center justify-center text-white text-xs font-bold flex-shrink-0 border-2 border-yellow-400">
                                T
                            </div>
                            <div class="flex-1 min-w-0">
