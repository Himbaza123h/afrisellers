    ...
    <div class="container mx-auto px-4">
        <div style="max-w-8xl; margin: 0 auto;">
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-12 gap-4">
                <div>
                    <h2 class="text-lg font-bold text-gray-900 mb-2">Request for Quotations</h2>
                    <p class="text-gray-600">Connect with buyers and grow your business</p>
                </div>
                <a href="{{ route('rfqs.create') }}" class="border-2 border-blue-600 text-blue-600 px-6 py-2.5 rounded-lg font-medium hover:bg-blue-50 transition-colors text-center inline-flex items-center justify-center gap-2 whitespace-nowrap">
