            ...
            @forelse($countriesWithProducts as $country)
                ...
                <div class="trending-country-card bg-white rounded-lg border border-transparent shadow-sm overflow-hidden hover:shadow-lg hover:border-[#faafaf] transition-all"
                    ...
                    <div class="relative">
                        ...
                        {{-- SLIDE / FADE / FLIP animation wrapper --}}
                        @php $useAnim = in_array($trendingAnim, ['slide','fade','flip']); @endphp
...
<script>
// ══════════════════════════════════════════════════════════════
// TRENDING PRODUCTS — carousel + country filter
// ══════════════════════════════════════════════════════════════
(function () {

    const ANIM = '{{ $trendingAnim }}'; // slide | fade | flip | none
...
dot.style.width = '';
    ...
    // ── Country filter (from top-bar country selector) ───────────
    function applyTrendingCountry(countryId) {
        ...
        // Also reset region dropdown when country changes
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Patch HeroSlideshow.applyCountry if it exists
...
<style>
/* Fade/flip: carousel track must be relative with fixed height */
.trending-carousel .carousel-track {
    min-height: 1px; /* overridden in JS */
}
