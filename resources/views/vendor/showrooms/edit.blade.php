...
<div class="mb-6">
    <div class="flex items-center gap-3 mb-2">
        ...
        <h1 class="text-2xl font-black text-gray-900 uppercase lg:text-lg">Edit Showroom</h1>
    </div>
    <p class="text-sm text-gray-600 ml-11">Update showroom information</p>
</div>
...
<form action="{{ route('vendor.showrooms.update', $showroom->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="description"
                                  ...
                                  rows="4"
                                  class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                                  placeholder="Describe your showroom...">{{ old('description', $showroom->description) }}</textarea>
                        @error('description')
                            <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text"
                                   name="business_type"
                                   id="business_type"
                                   value="{{ old('business_type', $showroom->business_type) }}"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                        ...
                        <div>
                            ...
                            <input type="text"
                                   name="industry"
                                   id="industry"
                                   value="{{ old('industry', $showroom->industry) }}"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                ...
                <div class="p-6 space-y-6">
                    <div>
                        ...
                        <textarea name="address"
                                  ...
                                  rows="2"
                                  class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                                  required>{{ old('address', $showroom->address) }}</textarea>
                        @error('address')
                            <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text"
                                   name="state_province"
                                   id="state_province"
                                   value="{{ old('state_province', $showroom->state_province) }}"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select name="country_id"
                                ...
                                @foreach($countries as $country)
                                    <option value="{{ $country->id }}" {{ old('country_id', $showroom->country_id) == $country->id ? 'selected' : '' }}>
                                        {{ $country->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div>
                            ...
                            <input type="text"
                                   name="postal_code"
                                   id="postal_code"
                                   value="{{ old('postal_code', $showroom->postal_code) }}"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent">
                            @error('postal_code')
                                <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                            @enderror
                ...
                <div class="p-6 space-y-6">
                    <div>
                        ...
                        <input type="text"
                               name="contact_person"
                               id="contact_person"
                               value="{{ old('contact_person', $showroom->contact_person) }}"
                               class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                               required>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="email"
                                   name="email"
                                   id="email"
                                   value="{{ old('email', $showroom->email) }}"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                                   required>
                            @error('email')
                                <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text"
                                   ...
                                   id="alternate_phone"
                                   value="{{ old('alternate_phone', $showroom->alternate_phone) }}"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent">
                        ...
                        <div>
                            ...
                            <input type="text"
                                   name="whatsapp"
                                   id="whatsapp"
                                   value="{{ old('whatsapp', $showroom->whatsapp) }}"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent">
                            @error('whatsapp')
                                <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                            @enderror
                    ...
                    <div>
                        ...
                        <input type="url"
                               name="website_url"
                               id="website_url"
                               value="{{ old('website_url', $showroom->website_url) }}"
                               class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h2 class="text-lg font-bold text-gray-900">Current Images</h2>
                </div>
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
                <div class="px-6 py-4 border-b border-gray-200">
                    <h2 class="text-lg font-bold text-gray-900">Update Images</h2>
                </div>
                <div class="p-6 space-y-6">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">New Primary Image</label>
                        <input type="file"
                               name="primary_image"
                               id="primary_image"
                               accept="image/*"
                        ...
                        <p class="text-xs text-gray-500 mt-1">JPG, PNG. Max 2MB. Leave empty to keep current.</p>
                        @error('primary_image')
                            <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">New Logo Image</label>
                        <input type="file"
                               name="logo_image"
                               id="logo_image"
                               accept="image/*"
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                <button type="submit"
                    ...
                    <i class="fas fa-save mr-2"></i>Update Showroom
                </button>
                <a href="{{ route('vendor.showrooms.show', $showroom->id) }}"
