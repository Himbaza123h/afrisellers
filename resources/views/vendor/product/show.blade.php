...
<style>
    ...
    /* Rich text / Quill HTML output styles */
    .rich-content h1, .rich-content h2, .rich-content h3 { font-weight: 700; margin-top: 1rem; margin-bottom: 0.5rem; }
    .rich-content h1 { font-size: 1.25rem; }
    .rich-content h2 { font-size: 1.1rem; }
    .rich-content h3 { font-size: 1rem; }
    .rich-content p  { margin-bottom: 0.5rem; line-height: 1.6; }
    ...
    .rich-content blockquote { border-left: 4px solid #d1d5db; padding-left: 1rem; color: #6b7280; margin: 0.5rem 0; }
</style>
@endpush
...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5">
        <div class="info-card p-6 bg-white rounded-xl border border-gray-200 shadow-sm">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center justify-center w-12 h-12 bg-green-50 to-green-100 rounded-md">
        ...
        <div class="info-card p-6 bg-white rounded-xl border border-gray-200 shadow-sm">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center justify-center w-12 h-12 bg-blue-50 to-blue-100 rounded-md">
        ...
        <div class="info-card p-6 bg-white rounded-xl border border-gray-200 shadow-sm">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center justify-center w-12 h-12 bg-purple-50 to-purple-100 rounded-md">
        ...
        <div class="info-card p-6 bg-white rounded-xl border border-gray-200 shadow-sm">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center justify-center w-12 h-12 bg-indigo-50 to-indigo-100 rounded-md">
        ...
        <div class="info-card p-6 bg-white rounded-xl border border-gray-200 shadow-sm">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center justify-center w-12 h-12 bg-yellow-50 to-yellow-100 rounded-md">
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div class="md:col-span-2">
                ...
                <div class="p-4 bg-gray-50 rounded-md border border-gray-200">
                    <div class="text-sm text-gray-700 rich-content">{!! $product->description !!}</div>
                </div>
            </div>
            @endif
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="p-5 bg-red-50 to-orange-50 rounded-xl border border-red-200">
