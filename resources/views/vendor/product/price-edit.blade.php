...
<div class="space-y-6">
    ...
    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl border border-blue-200 shadow-sm p-6">
        <div class="flex items-start gap-4">
            ...
            @else
                <div class="w-20 h-20 bg-gray-200 to-gray-300 rounded-lg flex items-center justify-center border-2 border-white shadow-md">
            ...
            <div id="priceTiersContainer" class="space-y-4">
                @if($prices && $prices->count() > 0)
                    @foreach($prices->sortBy('min_qty') as $index => $price)
                        <div class="p-5 bg-green-50 to-white rounded-xl border border-green-100 price-tier-item">
...
<script>
    ...
    function addPriceTier() {
        ...
        tierDiv.className = 'p-5 bg-green-50 to-white rounded-xl border border-green-100 price-tier-item';
        tierDiv.innerHTML = `
            <div class="grid grid-cols-1 gap-4 md:grid-cols-5">
                <div>
                    <label class="block mb-2 text-xs font-semibold text-gray-500 uppercase tracking-wider">
