...
<div class="space-y-5">
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between slide-up">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">Write and publish your blog article</p>
            </div>
        </div>
        <div class="flex items-center gap-2">
            <span class="px-3 py-1.5 bg-blue-50 text-blue-700 rounded-full text-xs font-medium">
                <i class="fas fa-edit mr-1"></i> New Article
            </span>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden slide-up" style="animation-delay: 0.2s;">
        <form action="{{ route('vendor.articles.store') }}" method="POST" enctype="multipart/form-data" id="articleForm">
            @csrf
            ...
            <div class="bg-gray-50 px-6 py-4 border-t border-gray-200 flex gap-3 justify-end items-center">
                ...
                <button type="submit" name="status" value="draft"
                    class="inline-flex items-center gap-2 px-5 py-2.5 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-all font-semibold shadow-md text-sm hover:shadow-lg">
