            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6 sticky top-6">
                    ...
                    <div class="space-y-3 mb-6 pb-6 border-b">
                        ...
                        <div>
                            <label for="currency" class="block text-sm text-gray-600 mb-1">Currency</label>
                            <select name="currency" id="currency" class="w-full px-3 py-1.5 border border-gray-300 rounded text-sm focus:ring-2 focus:ring-blue-500">
