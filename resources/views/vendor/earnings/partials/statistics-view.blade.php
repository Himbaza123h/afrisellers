...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    <div class="bg-blue-50 to-blue-100 rounded-xl p-6 border border-blue-200">
    ...
    <div class="bg-green-50 to-green-100 rounded-xl p-6 border border-green-200">
        <div class="flex items-center justify-between mb-4">
    ...
    <div class="bg-purple-50 to-purple-100 rounded-xl p-6 border border-purple-200">
        <div class="flex items-center justify-between mb-4">
