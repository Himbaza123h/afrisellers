...
<div class="space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="flex flex-wrap gap-3">
            @if(isset($rfqLimit))
                <div class="inline-flex items-center gap-2 px-4 py-2.5 bg-blue-50 to-blue-100 border border-blue-200 text-blue-700 rounded-lg font-medium shadow-sm">
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div class="stat-card p-6 bg-white rounded-xl border border-gray-200 shadow-sm">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center justify-center w-14 h-14 bg-yellow-50 to-yellow-100 rounded-xl">
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <div class="stat-card p-6 bg-white rounded-xl border border-gray-200 shadow-sm">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center justify-center w-14 h-14 bg-indigo-50 to-indigo-100 rounded-xl">
        ...
        <div class="stat-card p-6 bg-white rounded-xl border border-gray-200 shadow-sm">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center justify-center w-14 h-14 bg-red-50 to-red-100 rounded-xl">
        ...
        <div class="stat-card p-6 bg-white rounded-xl border border-gray-200 shadow-sm">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center justify-center w-14 h-14 bg-emerald-50 to-emerald-100 rounded-xl">
                        ...
                        <tr class="hover:bg-gray-50">
                                ...
                                <div class="flex flex-col gap-1">
                                    @if($rfq->product)
                                        <div class="flex items-center gap-2">
                                            <div class="w-10 h-10 bg-blue-100 to-blue-200 rounded-lg flex items-center justify-center">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <div class="flex items-center justify-center w-10 h-10 bg-green-100 to-green-200 rounded-full">
