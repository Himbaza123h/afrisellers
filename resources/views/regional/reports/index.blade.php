...
<div class="space-y-4">
    ...
    <div id="tab-overview-content" class="tab-content">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-4">
            <!-- Vendors Card -->
            <div class="stat-card p-4 bg-blue-500 to-blue-600 rounded-lg shadow-sm text-white">
            ...
            <!-- Products Card -->
            <div class="stat-card p-4 bg-purple-500 to-purple-600 rounded-lg shadow-sm text-white">
                <div class="flex items-center justify-between mb-3">
            ...
            <!-- Orders Card -->
            <div class="stat-card p-4 bg-green-500 to-green-600 rounded-lg shadow-sm text-white">
                <div class="flex items-center justify-between mb-3">
            ...
            <!-- Loads Card -->
            <div class="stat-card p-4 bg-orange-500 to-orange-600 rounded-lg shadow-sm text-white">
                <div class="flex items-center justify-between mb-3">
