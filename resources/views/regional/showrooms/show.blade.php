    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between no-print">
        <div>
            <div class="flex items-center gap-3 mb-2">
                <a href="{{ route('regional.showrooms.index') }}" class="text-gray-600 hover:text-gray-900 transition-colors">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                ...
                <div class="space-y-4">
                    <div class="flex items-center gap-3">
                        <div class="flex items-center justify-center w-12 h-12 bg-blue-100 to-blue-200 rounded-full">
                    ...
                    @if($showroom->address)
                        <div class="flex items-start gap-2">
                            ...
                            <div>
                                ...
                                <p class="text-gray-700">{{ $showroom->city }}, {{ $showroom->postal_code }}</p>
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6 no-print">
                ...
                <div class="space-y-2">
                    @if(!$showroom->is_verified)
                        <form action="{{ route('regional.showrooms.verify', $showroom->id) }}" method="POST">
                            @csrf
                    ...
                    @endif
                    <form action="{{ route('regional.showrooms.feature', $showroom->id) }}" method="POST">
                        @csrf
                    ...
                    <form action="{{ route('regional.showrooms.destroy', $showroom->id) }}" method="POST" onsubmit="return confirm('Delete this showroom?')">
                        @csrf
                        @method('DELETE')
