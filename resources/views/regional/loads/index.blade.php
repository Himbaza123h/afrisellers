...
<div class="space-y-4">
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-xl font-bold text-gray-900">Regional Loads Management</h1>
            <p class="mt-1 text-xs text-gray-500">Monitor freight loads across {{ $region->name }} region ({{ $countries->count() }} countries)</p>
        </div>
        <div class="flex flex-wrap gap-2">
            <button onclick="window.open('{{ route('regional.loads.print') }}' + window.location.search, '_blank')" class="inline-flex items-center gap-2 px-3 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-all font-medium shadow-sm text-sm">
    ...
    <div class="flex gap-2 border-b border-gray-200 no-print">
        ...
        <button onclick="switchTab('routes')" id="tab-routes" class="tab-button px-4 py-2 text-sm font-semibold text-gray-600 hover:text-gray-900 transition-colors">
    ...
    <div id="tab-overview-content" class="tab-content">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            <div class="stat-card p-4 bg-white rounded-lg border border-gray-200 shadow-sm">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center justify-center w-12 h-12 bg-blue-50 to-blue-100 rounded-lg">
            ...
            <div class="stat-card p-4 bg-white rounded-lg border border-gray-200 shadow-sm">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center justify-center w-12 h-12 bg-yellow-50 to-yellow-100 rounded-lg">
            ...
            <div class="stat-card p-4 bg-white rounded-lg border border-gray-200 shadow-sm">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center justify-center w-12 h-12 bg-indigo-50 to-indigo-100 rounded-lg">
            ...
            <div class="stat-card p-4 bg-white rounded-lg border border-gray-200 shadow-sm">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center justify-center w-12 h-12 bg-green-50 to-green-100 rounded-lg">
            ...
            <div class="stat-card p-4 bg-white rounded-lg border border-gray-200 shadow-sm">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center justify-center w-12 h-12 bg-purple-50 to-purple-100 rounded-lg">
            ...
            <div class="stat-card p-4 bg-white rounded-lg border border-gray-200 shadow-sm">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center justify-center w-12 h-12 bg-red-50 to-red-100 rounded-lg">
            ...
            <div class="stat-card p-4 bg-white rounded-lg border border-gray-200 shadow-sm">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center justify-center w-12 h-12 bg-orange-50 to-orange-100 rounded-lg">
            ...
            <div class="stat-card p-4 bg-white rounded-lg border border-gray-200 shadow-sm">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center justify-center w-12 h-12 bg-teal-50 to-teal-100 rounded-lg">
        ...
        <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-4 mt-4">
            <form method="GET" action="{{ route('regional.loads.index') }}" class="space-y-3">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-3">
                    ...
                    <div>
                        ...
                        <input type="text" id="dateRangePicker" name="date_range" value="{{ request('date_range') }}" placeholder="Select dates" readonly class="w-full px-3 py-2 border border-gray-300 rounded-lg cursor-pointer text-sm">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-3">
                    ...
                    <div>
                        ...
                        <select name="pricing_type" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm">
                            <option value="">All Types</option>
                    ...
                    <!-- Origin City -->
                    <div>
                        <label class="block text-xs font-medium text-gray-700 mb-1">Origin City</label>
                    ...
                    <!-- Destination City -->
                    <div>
                        <label class="block text-xs font-medium text-gray-700 mb-1">Destination City</label>
                        <select name="destination_city" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm">
                            <option value="">All Cities</option>
                ...
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('regional.loads.index') }}" class="inline-flex items-center gap-1 px-3 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 text-sm font-medium">
        ...
        <div class="bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden">
            ...
            <div class="overflow-x-auto custom-scrollbar">
                <table class="w-full text-sm">
                    <thead class="bg-gray-50 border-b">
                        <tr>
                            <th class="px-4 py-2 text-left text-xs font-semibold text-gray-700 uppercase">Load Info</th>
                            ...
                            <th class="px-4 py-2 text-left text-xs font-semibold text-gray-700 uppercase">Pickup Date</th>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        @forelse($loads as $load)
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3">
                                    <p class="text-sm font-medium text-gray-900">{{ $load->user->name ?? 'N/A' }}</p>
                                    <p class="text-xs text-gray-500">{{ Str::limit($load->user->email ?? 'N/A', 20) }}</p>
                                </td>
                                <td class="px-4 py-3">
                                ...
                                <td class="px-4 py-3">
                                    <p class="text-sm font-medium text-gray-900">{{ $load->pickup_date ? $load->pickup_date->format('M d, Y') : 'N/A' }}</p>
                                </td>
                                <td class="px-4 py-3">
                                    @if($load->budget)
                                        <p class="text-sm font-bold text-gray-900">{{ $load->currency }} {{ number_format($load->budget, 2) }}</p>
                                    @else
                                ...
                                <td class="px-4 py-3 text-right">
                                    <a href="{{ route('regional.loads.show', $load->id) }}" class="text-blue-600 hover:text-blue-700 text-sm font-medium px-2 py-1 rounded hover:bg-blue-50" title="View">
            ...
            @if($loads->hasPages())
                <div class="px-4 py-3 border-t border-gray-200">
                    <div class="flex items-center justify-between">
                        <span class="text-xs text-gray-700">Showing {{ $loads->firstItem() }}-{{ $loads->lastItem() }} of {{ $loads->total() }}</span>
                        <div class="text-sm">{{ $loads->links() }}</div>
                    </div>
                </div>
            @endif
        </div>
    ...
    <!-- Routes Tab Content -->
    <div id="tab-routes-content" class="tab-content hidden">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <!-- Popular Routes -->
            <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-4">
                <h3 class="text-base font-semibold text-gray-900 mb-4">Popular Routes</h3>
                <div class="space-y-3">
                    @php
                        $popularRoutes = $loads->groupBy(function($load) {
                            return $load->origin_city . ' → ' . $load->destination_city;
                        })->sortByDesc(function($group) {
                            return $group->count();
                        })->take(5);
                    @endphp

                    @forelse($popularRoutes as $route => $routeLoads)
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500">{{ $routeLoads->count() }} loads</p>
                                </div>
                            </div>
                            <span class="text-sm font-bold text-blue-600">{{ $routeLoads->count() }}</span>
                        </div>
                    @empty
                        <div class="text-center py-8">
                            <i class="fas fa-route text-4xl text-gray-300 mb-2"></i>
                            <p class="text-sm text-gray-500">No routes available</p>
                        </div>
                    @endforelse
                </div>
            </div>
            ...
            <!-- Cities Overview -->
            <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-4">
                <h3 class="text-base font-semibold text-gray-900 mb-4">Cities Overview</h3>
                <div class="space-y-3">
                    <div class="p-3 bg-green-50 rounded-lg">
                        <div class="flex items-center justify-between">
                            <span class="text-sm font-medium text-gray-700">Origin Cities</span>
                            <i class="fas fa-arrow-up text-green-600"></i>
                        </div>
                        <p class="text-2xl font-bold text-gray-900 mt-2">{{ $originCities->count() }}</p>
                        <p class="text-xs text-gray-500 mt-1">Unique departure cities</p>
                    </div>

                    <div class="p-3 bg-red-50 rounded-lg">
                        <div class="flex items-center justify-between">
                            <span class="text-sm font-medium text-gray-700">Destination Cities</span>
                            <i class="fas fa-arrow-down text-red-600"></i>
                        </div>
                        <p class="text-2xl font-bold text-gray-900 mt-2">{{ $destinationCities->count() }}</p>
                        <p class="text-xs text-gray-500 mt-1">Unique arrival cities</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="tab-analytics-content" class="tab-content hidden">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <!-- Status Distribution -->
            <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-4">
                <h3 class="text-base font-semibold text-gray-900 mb-4">Load Status Distribution</h3>
                <div class="space-y-4">
                    <div>
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-sm font-medium text-gray-700">Posted</span>
                            <span class="text-sm font-bold text-blue-700">{{ number_format($stats['posted']) }}</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-3">
                            <div class="bg-blue-600 h-3 rounded-full" style="width: {{ $stats['posted_percentage'] }}%"></div>
                        </div>
                        <p class="text-xs text-gray-500 mt-1">{{ $stats['posted_percentage'] }}% of total</p>
                    </div>

                    <div>
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-sm font-medium text-gray-700">Bidding</span>
                            <span class="text-sm font-bold text-yellow-700">{{ number_format($stats['bidding']) }}</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-3">
                            <div class="bg-yellow-600 h-3 rounded-full" style="width: {{ $stats['total'] > 0 ? round(($stats['bidding'] / $stats['total']) * 100) : 0 }}%"></div>
                        </div>
                        <p class="text-xs text-gray-500 mt-1">{{ $stats['total'] > 0 ? round(($stats['bidding'] / $stats['total']) * 100) : 0 }}% of total</p>
                    </div>

                    <div>
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-sm font-medium text-gray-700">Delivered</span>
                            <span class="text-sm font-bold text-green-700">{{ number_format($stats['delivered']) }}</span>
                        </div>
                        <div class="w-full bg-gray-200 rounded-full h-3">
                            <div class="bg-green-600 h-3 rounded-full" style="width: {{ $stats['delivered_percentage'] }}%"></div>
                        </div>
                        <p class="text-xs text-gray-500 mt-1">{{ $stats['delivered_percentage'] }}% of total</p>
                    </div>
                </div>
            </div>
            ...
            <!-- Recent Loads -->
            <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-4">
                <h3 class="text-base font-semibold text-gray-900 mb-4">Recent Loads</h3>
                <div class="space-y-3">
                    @php
                        $recentLoads = $loads->take(5);
                    @endphp
                    ...
                    @forelse($recentLoads as $load)
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100">
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center">
                                    <i class="fas fa-truck-loading text-blue-600 text-sm"></i>
                                </div>
                                <div>
                                    <p class="text-sm font-medium text-gray-900">{{ $load->load_number }}</p>
                                    <p class="text-xs text-gray-500">{{ $load->created_at->diffForHumans() }}</p>
                                </div>
                            </div>
                            <div class="flex items-center gap-2">
                                ...
                                @endphp
                                <span class="px-2 py-1 rounded-full text-xs font-medium {{ $status[1] }}">{{ $status[0] }}</span>
                                <a href="{{ route('regional.loads.show', $load->id) }}" class="text-blue-600 hover:text-blue-700 text-sm font-medium px-2 py-1 rounded hover:bg-blue-50">
                                    <i class="fas fa-eye"></i>
                                </a>
                            </div>
                        </div>
                    @empty
                        <div class="text-center py-8">
                            ...
                            <p class="text-sm text-gray-500">No recent loads</p>
                        </div>
                    @endforelse
                </div>
            </div>
