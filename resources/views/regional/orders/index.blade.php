...
<div class="space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Regional Orders Management</h1>
            <p class="mt-1 text-sm text-gray-500">Monitor orders across {{ $region->name }}</p>
        </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-4">
        <form method="GET" action="{{ route('regional.orders.index') }}" class="space-y-4">
            ...
            <div class="flex flex-wrap gap-3 items-center">
                ...
                @if(request()->hasAny(['search', 'date_range', 'country_id', 'status', 'payment_status', 'sort_by']))
                    <a href="{{ route('regional.orders.index') }}" class="inline-flex items-center gap-2 px-4 py-2.5 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 font-medium">
...
<a href="{{ route('regional.orders.show', $order->id) }}" class="p-2 text-gray-600 rounded-lg hover:bg-blue-50 hover:text-blue-600" title="View Details">
...
<p class="text-sm text-gray-500 mb-6">Orders from your region will appear here</p>
</div>
</td>
</tr>
@endforelse
