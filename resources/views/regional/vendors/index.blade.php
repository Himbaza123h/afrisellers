...
<div class="space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Regional Vendors Management</h1>
            <p class="mt-1 text-sm text-gray-500">Monitor and manage vendors across {{ $region->name }} region ({{ $countries->count() }} countries)</p>
        </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-4">
        <form method="GET" action="{{ route('regional.vendors.index') }}" class="space-y-4">
            ...
            <div class="flex flex-wrap gap-3 items-center">
                ...
                @if(request()->hasAny(['search', 'country_id', 'date_range', 'account_status', 'email_verified', 'business_verified', 'sort_by']))
                    <a href="{{ route('regional.vendors.index') }}" class="inline-flex items-center gap-2 px-4 py-2.5 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 font-medium">
            ...
            <table class="w-full">
                <thead class="bg-gray-50 border-b">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-xs font-semibold text-left text-gray-700 uppercase">Email</th>
                        <th class="px-6 py-4 text-xs font-semibold text-left text-gray-700 uppercase">Business</th>
                        ...
                        <tr class="hover:bg-gray-50">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="flex flex-col">
                                        <span class="text-sm font-semibold text-gray-900">
                                            {{ Str::limit($vendor->businessProfile->business_name ?? 'N/A', 20) }}
                                        </span>
                                        <span class="text-xs text-gray-500">ID: #{{ $vendor->id }}</span>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="{{ route('regional.vendors.show', $vendor->id) }}" class="p-2 text-gray-600 rounded-lg hover:bg-blue-50 hover:text-blue-600" title="View Details">
                                    ...
                                    @if($vendor->account_status === 'active')
                                        <form action="{{ route('regional.vendors.suspend', $vendor->id) }}" method="POST" class="inline">
                                            @csrf
                                            <button type="submit" class="p-2 text-gray-600 rounded-lg hover:bg-red-50 hover:text-red-600" title="Suspend" onclick="return confirm('Suspend this vendor?')">
                        ...
                        <tr>
                            <td colspan="8" class="px-6 py-20 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-sm text-gray-500">Vendors from your region will appear here</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
