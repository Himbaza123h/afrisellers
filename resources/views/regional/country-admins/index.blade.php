                            ...
                            <tr class="hover:bg-gray-50">
                                <td class="px-4 py-3">
                                    <div class="flex items-center gap-3">
                                        <div class="w-8 h-8 bg-purple-100 to-purple-200 rounded-full flex items-center justify-center">
    ...
    <div id="tab-activity-content" class="tab-content hidden">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-4">
                ...
                <!-- Summary Stats -->
                <div class="mt-6 p-4 bg-blue-50 to-white rounded-lg border border-blue-100">
