...
<div class="flex-shrink-0 p-3 border-b border-gray-200 bg-gradient-to-r from-blue-50 to-purple-50">
    <div class="flex items-center justify-between">
        ...
        <button onclick="loadGroupSettings({{ $group->id }})" class="p-2 text-gray-600 hover:bg-gray-100 rounded-lg text-sm">
...
<div class="flex-shrink-0 border-t border-gray-200 bg-white">
    @if($canSendMessage)
        ...
        <div class="px-3 pb-3 flex items-center gap-2">
            ...
            <button type="button" onclick="sendGroupMessage({{ $group->id }})" class="flex-1 px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 font-medium text-sm">
