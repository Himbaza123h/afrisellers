                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                <div class="flex items-center justify-center w-10 h-10 bg-blue-100 to-blue-200 rounded-lg">
                        ...
                        <td class="px-6 py-4">
                            @if($load->assignedTransporter)
                                <div class="flex items-center gap-2">
                                    <div class="w-8 h-8 bg-green-100 to-green-200 rounded-full flex items-center justify-center">
