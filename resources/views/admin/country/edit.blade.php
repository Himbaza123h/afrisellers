...
<div class="mb-4 sm:mb-6 lg:mb-8">
    <div class="flex items-center gap-3 mb-3">
        ...
        <div>
            ...
            <p class="text-xs sm:text-sm text-gray-600 mt-1">Update country information — <span class="font-semibold text-gray-800">{{ $country->name }}</span></p>
        </div>
    </div>
</div>
    ...
    <form action="{{ route('admin.country.update', $country) }}" method="POST" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <input type="text" name="code" id="code" value="{{ old('code', $country->code) }}" maxlength="3"
                ...
                <select name="region_id" id="region_id"
                    ...
                    @foreach($regions as $region)
                        <option value="{{ $region->id }}"
                            {{ old('region_id', $country->region_id) == $region->id ? 'selected' : '' }}>
                            {{ $region->name }}
        ...
        <div>
            ...
            <div class="flex gap-3 items-start">
                <div class="flex-1">
                    <input type="url" name="flag_url" id="flag_url"
                ...
                <div id="flagPreviewWrap" class="{{ ($country->flag_url || old('flag_url')) ? '' : 'hidden' }} border border-gray-200 rounded-lg p-2 bg-gray-50 flex-shrink-0">
                    <img id="flagPreview"
                         src="{{ old('flag_url', $country->flag_url ?? '') }}"
                         alt="Flag preview"
