...
<div class="space-y-4">
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-xl font-bold text-gray-900">Showrooms Management</h1>
            <p class="mt-1 text-xs text-gray-500">Manage all registered showrooms and exhibitions</p>
        </div>
    ...
    <div id="stats-section" class="stats-container">
        @include('admin.showrooms.partials.stats')
    </div>

    <!-- Table Section (shared across tabs) -->
    <div id="table-section" class="table-container">
        @include('admin.showrooms.partials.table')
    </div>
</div>
...
function printReport() {
    window.open('{{ route("admin.showrooms.print") }}', '_blank');
}
