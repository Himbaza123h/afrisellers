...
<div class="space-y-6">
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-3">
                                <div class="flex items-center justify-center w-10 h-10 rounded-lg
                                    {{ $index === 0 ? 'bg-yellow-200 to-yellow-400' :
                                       ($index === 1 ? 'bg-gray-200 to-gray-400' :
                                       ($index === 2 ? 'bg-orange-200 to-orange-400' : 'bg-blue-100 to-blue-200')) }}">
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <!-- Best Seller -->
            <div class="p-4 bg-green-50 to-green-100 rounded-xl border border-green-200">
            ...
            <!-- Highest Volume -->
            <div class="p-4 bg-blue-50 to-blue-100 rounded-xl border border-blue-200">
                <div class="flex items-center gap-2 mb-2">
            ...
            <!-- Most Popular -->
            <div class="p-4 bg-purple-50 to-purple-100 rounded-xl border border-purple-200">
                <div class="flex items-center gap-2 mb-2">
            ...
            <!-- Premium Product -->
            <div class="p-4 bg-amber-50 to-amber-100 rounded-xl border border-amber-200">
                <div class="flex items-center gap-2 mb-2">
