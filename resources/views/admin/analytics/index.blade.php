...
<div class="space-y-4">
    ...
    <div id="stats-section" class="stats-container hidden">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 mt-4">
            <div class="stat-card p-4 bg-blue-50 to-blue-100 rounded-lg border border-blue-200 shadow-sm">
            ...
            <div class="stat-card p-4 bg-purple-50 to-purple-100 rounded-lg border border-purple-200 shadow-sm">
                <div class="flex items-center gap-2 mb-2">
            ...
            <div class="stat-card p-4 bg-green-50 to-green-100 rounded-lg border border-green-200 shadow-sm">
                <div class="flex items-center gap-2 mb-2">
            ...
            <div class="stat-card p-4 bg-orange-50 to-orange-100 rounded-lg border border-orange-200 shadow-sm">
                <div class="flex items-center gap-2 mb-2">
