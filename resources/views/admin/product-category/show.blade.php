    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
        ...
        <div class="stat-card p-6 bg-white rounded-xl border border-gray-200 shadow-sm">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center justify-center w-14 h-14 bg-{{ $productCategory->status === 'active' ? 'green' : 'gray' }}-50 to-{{ $productCategory->status === 'active' ? 'green' : 'gray' }}-100 rounded-xl">
