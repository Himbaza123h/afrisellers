...
<div class="mb-4 sm:mb-6 lg:mb-8">
    <div class="flex items-center gap-3 mb-3">
        ...
        <div>
            <h1 class="text-xl sm:text-2xl lg:text-lg font-black text-gray-900 uppercase">Add New Product</h1>
            <p class="text-xs sm:text-sm text-gray-600 mt-1">Create a new product entry</p>
        </div>
    </div>
</div>
...
<div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
    <form action="{{ route('admin.product.store') }}" method="POST" class="space-y-6" id="productForm">
        @csrf
