...
<div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5 mt-4">
    ...
    <div class="stat-card p-6 bg-white rounded-xl border border-gray-200 shadow-sm">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center justify-center w-12 h-12 bg-violet-50 to-violet-100 rounded-xl">
    ...
    <div class="stat-card p-6 bg-white rounded-xl border border-gray-200 shadow-sm">
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center justify-center w-12 h-12 bg-cyan-50 to-cyan-100 rounded-xl">
