...
<div class="space-y-4">
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-1 text-xs text-gray-500">Manage all registered sales agents</p>
        </div>

        <div class="flex flex-wrap gap-2 no-print">
            <a href="{{ route('admin.agents.create') }}"
            class="inline-flex items-center gap-2 px-3 py-2 bg-[#ff0808] text-white rounded-lg hover:bg-[#dd0606] transition-all font-medium shadow-sm text-sm">
...
function printReport() {
    window.open('{{ route("admin.agents.print") }}', '_blank');
}
</script>
@endsection
