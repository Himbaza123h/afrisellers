    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5">
        <div class="p-6 bg-white rounded-xl border border-gray-200 shadow-sm">
            <div class="flex items-center justify-between">
                ...
                <div class="w-12 h-12 bg-blue-50 to-blue-100 rounded-lg flex items-center justify-center">
        ...
        <div class="p-6 bg-white rounded-xl border border-gray-200 shadow-sm">
            <div class="flex items-center justify-between">
                ...
                <div class="w-12 h-12 bg-green-50 to-green-100 rounded-lg flex items-center justify-center">
        ...
        <div class="p-6 bg-white rounded-xl border border-gray-200 shadow-sm">
            <div class="flex items-center justify-between">
                ...
                <div class="w-12 h-12 bg-purple-50 to-purple-100 rounded-lg flex items-center justify-center">
        ...
        <div class="p-6 bg-white rounded-xl border border-gray-200 shadow-sm">
            <div class="flex items-center justify-between">
                ...
                <div class="w-12 h-12 bg-orange-50 to-orange-100 rounded-lg flex items-center justify-center">
        ...
        <div class="p-6 bg-white rounded-xl border border-gray-200 shadow-sm">
            <div class="flex items-center justify-between">
                ...
                <div class="w-12 h-12 bg-red-50 to-red-100 rounded-lg flex items-center justify-center">
