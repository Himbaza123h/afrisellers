...
<div class="space-y-4">
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-xl font-bold text-gray-900">RFQs Management</h1>
            <p class="mt-1 text-xs text-gray-500">Track and manage all Request for Quotations</p>
        </div>
...
function printReport() {
    window.open('{{ route("admin.rfqs.print") }}', '_blank');
}
