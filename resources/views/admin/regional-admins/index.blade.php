...
<div class="space-y-4">
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-xl font-bold text-gray-900">Regional Administrators</h1>
            <p class="mt-1 text-xs text-gray-500">Manage regional administrators and their assignments</p>
        </div>
        <div class="flex flex-wrap gap-2 no-print">
            ...
            <a href="{{ route('admin.regional-admins.create') }}" class="inline-flex items-center gap-2 px-3 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all font-medium shadow-sm text-sm">
    ...
    <!-- All Tab Content (Default) -->
    <div id="content-all">
        @include('admin.regional-admins.partials.stats')
        <div class="mt-4">
            @include('admin.regional-admins.partials.table')
        </div>
    </div>
...
function printReport() {
    window.open('{{ route("admin.regional-admins.print") }}', '_blank');
}
</script>
@endsection
