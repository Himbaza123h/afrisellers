...
<div class="max-w-6xl mx-auto space-y-5">
    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            <h1 class="text-xl font-bold text-gray-900">Add Partner</h1>
            <p class="text-xs text-gray-500">Add a new trusted partner to display on the homepage</p>
        </div>
    </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="partner_type" value="{{ old('partner_type') }}"
                           class="w-full px-3 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#ff0808]"
                ...
                <div class="flex items-center gap-3 pt-5">
                    ...
                    <label for="is_active" class="text-sm font-medium text-gray-700">Active (visible on homepage)</label>
                </div>
            </div>
            ...
            <div>
                ...
                <p class="text-xs text-gray-400 mt-1">Supports JPG, PNG, GIF, WebP, SVG. Max 5MB.</p>
            </div>
...
const quill = new Quill('#descEditor', {
    theme: 'snow',
    placeholder: 'Write a description about this partner...',
