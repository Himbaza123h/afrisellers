        ...
        <div class="space-y-6">
            ...
            @if($commission->user)
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                    ...
                    <div class="flex items-center gap-3 mb-4">
                        <div class="w-12 h-12 bg-purple-100 to-purple-200 rounded-full flex items-center justify-center">
            ...
            @if($commission->vendor)
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                    ...
                    <div class="flex items-center gap-3 mb-4">
                        <div class="w-12 h-12 bg-blue-100 to-blue-200 rounded-full flex items-center justify-center">
            ...
            @if($commission->buyer)
                <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                    ...
                    <div class="flex items-center gap-3 mb-4">
                        <div class="w-12 h-12 bg-green-100 to-green-200 rounded-full flex items-center justify-center">
            ...
            <!-- Quick Stats -->
            <div class="bg-blue-50 to-purple-50 rounded-xl border border-blue-200 p-6">
