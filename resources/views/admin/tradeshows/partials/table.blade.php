...
<!-- Table -->
<div class="overflow-hidden bg-white rounded-lg border border-gray-200 shadow-sm mt-4">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                <div class="flex items-center justify-center w-10 h-10 bg-purple-100 to-purple-200 rounded-lg">
