...
<div class="space-y-4">
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-xl font-bold text-gray-900">Buyers</h1>
            <p class="mt-1 text-xs text-gray-500">Manage all registered buyers</p>
        </div>
...
function printReport() {
    window.open('{{ route("admin.buyers.print") }}', '_blank');
}
</script>
@endsection
