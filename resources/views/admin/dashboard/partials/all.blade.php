        ...
        <div class="space-y-3">
            ...
            <div class="pb-3 border-b border-gray-100 last:border-0 last:pb-0">
                ...
                <div class="flex gap-1.5 ml-10">
                    ...
                    <form action="{{ $action['route'] }}" method="GET" class="inline-block">
                        @csrf
                        <button type="submit" class="px-2.5 py-1 bg-{{ $action['color'] }}-600 text-white text-[10px] font-bold rounded hover:bg-{{ $action['color'] }}-700 transition-colors">
...
<div class="bg-white rounded-lg p-4 border border-gray-200 shadow-sm mb-4 sm:mb-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-3">
        ...
        <div class="p-3 bg-{{ $region['color'] }}-50 to-white rounded-lg border border-{{ $region['color'] }}-100">
