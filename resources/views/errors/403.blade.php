...
<head>
    ...
    <title>403 — Access Denied · {{ \App\Models\SystemSetting::get('site_name', config('app.name')) }}</title>
    ...
    <style>
        *, *::before, *::after { box-sizing:border-box; margin:0; padding:0 }
        ...
        .status-row {
            ...
            background:rgba(255,8,8,.08); border:1px solid rgba(255,8,8,.2);
            margin-bottom:18px;
        }
        .status-icon { font-size:13px; color:#ff0808 }
        .status-text { font-size:11.5px; font-weight:700; color:#ff0808 }
        ...
        .btn-ghost:hover { border-color:#ff0808; color:#ff0808; background:#FFF5F5 }
...
<body>
    ...
    <div class="main">
        ...
        <div class="status-row">
            ...
            <span class="status-text">Access denied</span>
        </div>

        <div class="title">You can't view this page</div>
        <div class="desc">
            You don't have permission to access this.<br>
