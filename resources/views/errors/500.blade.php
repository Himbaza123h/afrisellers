...
<head>
    ...
    <title>500 — Server Error · {{ \App\Models\SystemSetting::get('site_name', config('app.name')) }}</title>
...
<body>
    ...
    <div class="main">
        ...
        <div class="desc">
            Our server ran into an unexpected error.<br>
    ...
    <p class="footer-note">
        Still broken? <a href="mailto:{{ \App\Models\SystemSetting::get('site_email', config('mail.from.address')) }}">Contact support</a>
    </p>
