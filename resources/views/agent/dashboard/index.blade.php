    ...
    <div id="tab-overview-content" class="tab-content">
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-start gap-3 pb-4 border-b border-gray-100 last:border-0 last:pb-0">
                        <div class="flex items-center justify-center w-10 h-10 bg-{{ $referral['color'] }}-50 to-{{ $referral['color'] }}-100 rounded-lg flex-shrink-0">
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6 mt-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div class="p-5 bg-{{ $stat['color'] }}-50 to-white rounded-xl border border-{{ $stat['color'] }}-100">
                    <div class="mb-3">
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <div class="flex items-center justify-center w-10 h-10 bg-{{ $commission['color'] }}-50 to-{{ $commission['color'] }}-100 rounded-lg">
    ...
    <div id="tab-commissions-content" class="tab-content hidden">
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                ...
                <div class="p-5 bg-orange-50 to-orange-100 rounded-xl border border-orange-200">
                ...
                <div class="p-5 bg-purple-50 to-purple-100 rounded-xl border border-purple-200">
