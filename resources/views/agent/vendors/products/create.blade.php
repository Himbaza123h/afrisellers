...
<form action="{{ route('agent.vendors.products.store', $vendor->id) }}"
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div id="imageLimitWarn" class="hidden text-xs text-red-500 font-medium">
                        <i class="fas fa-exclamation-circle mr-1"></i>Maximum 4 images. Extra files ignored.
                    </div>
        ...
        <div class="space-y-6">
            ...
            <div class="flex gap-3">
                ...
                <button type="submit"
                        class="flex-1 inline-flex justify-center items-center gap-2 px-4 py-2.5 text-sm font-semibold text-white bg-[#ff0808] rounded-lg hover:bg-red-700">
...
function renderPreviews() {
    ...
    allFiles.forEach((file, i) => {
        ...
        reader.onload = e => {
            ...
            div.innerHTML = `
                <img src="${e.target.result}" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-200">
                ${i === 0 ? `<div class="absolute top-1.5 left-1.5 px-1.5 py-0.5 bg-[#ff0808] text-white text-[9px] font-bold rounded shadow">Primary</div>` : ''}
