...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    @if($currentSubscription)
        <div class="p-4 bg-blue-50 rounded-xl border border-blue-200 flex items-start gap-3 mb-8">
            ...
            <a href="{{ route('agent.subscriptions.index') }}" class="text-sm font-medium text-blue-600 hover:text-blue-700 whitespace-nowrap">
                Manage →
            </a>
        </div>
    @endif
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
        @forelse($packages as $package)
            <div class="package-card relative bg-white rounded-2xl shadow-lg border-2 {{ $package->is_featured ? 'border-purple-500' : 'border-gray-200' }} overflow-hidden">
                ...
                <!-- Package Header -->
                <div class="p-8 bg-{{ $package->badge_color }}-50 to-{{ $package->badge_color }}-100 border-b border-{{ $package->badge_color }}-200">
    ...
    <!-- Benefits Section -->
    <div class="bg-blue-50 to-purple-50 rounded-2xl p-8 mb-12">
