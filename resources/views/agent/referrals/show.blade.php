...
<div class="max-w-7xl mx-auto space-y-6">
    ...
    <!-- Toast Notification -->
<div id="toast" class="fixed top-5 right-5 z-50 hidden items-center gap-3 px-4 py-3 bg-green-600 text-white rounded-xl shadow-lg transition-all duration-300">
    <i class="fas fa-check-circle text-lg"></i>
    <p class="text-sm font-semibold">Referral code copied!</p>
</div>
    <!-- Page Header -->
