...
<div class="space-y-4">
    ...
    <div id="stats-section" class="stats-container">
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
            ...
            <div class="stat-card p-4 bg-white rounded-xl border border-gray-200 shadow-sm">
                <div class="flex items-center justify-between mb-2">
                    <div class="flex items-center justify-center w-10 h-10 bg-gray-50 to-gray-100 rounded-lg">
            ...
            <div class="stat-card p-4 bg-white rounded-xl border border-gray-200 shadow-sm">
                <div class="flex items-center justify-between mb-2">
                    <div class="flex items-center justify-center w-10 h-10 bg-red-50 to-red-100 rounded-lg">
