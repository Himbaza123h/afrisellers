    ...
    <div class="p-4">
        ...
        @if (auth()->user()->hasRole('agent'))
            ...
            <a href="{{ route('agent.referrals.index') }}"
               class="flex items-center px-4 py-3 text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-600 transition-colors {{ request()->routeIs('agent.referrals.*') ? 'bg-blue-50 text-blue-600' : '' }}">
