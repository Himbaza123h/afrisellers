...
<div class="space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Country Showrooms Management</h1>
            <p class="mt-1 text-sm text-gray-500">Monitor and manage showrooms in {{ Auth::user()->country->name ?? 'your country' }}</p>
        </div>
                ...
                <div class="flex-1">
                    ...
                    <div class="mt-3 flex items-center gap-1">
                        <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                            <i class="fas fa-flag mr-1 text-[10px]"></i> Country
                        </span>
                    </div>
                </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-4">
        <form method="GET" action="{{ route('country.showrooms.index') }}" class="space-y-4">
            ...
            <div class="flex flex-wrap gap-3 items-center">
                ...
                @if(request()->hasAny(['search', 'city', 'date_range', 'status', 'verification', 'featured', 'business_type', 'sort_by']))
                    <a href="{{ route('country.showrooms.index') }}" class="inline-flex items-center gap-2 px-4 py-2.5 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 font-medium">
            ...
            <table class="w-full">
                <thead class="bg-gray-50 border-b">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-xs font-semibold text-left text-gray-700 uppercase">City</th>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="{{ route('country.showrooms.show', $showroom->id) }}" class="p-2 text-gray-600 rounded-lg hover:bg-blue-50 hover:text-blue-600" title="View">
                                    ...
                                    <form action="{{ route('country.showrooms.destroy', $showroom->id) }}" method="POST" class="inline" onsubmit="return confirm('Delete this showroom?')">
                                        @csrf
                                        @method('DELETE')
                        ...
                        <tr>
                            <td colspan="9" class="px-6 py-20 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-sm text-gray-500">Showrooms from your country will appear here</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
