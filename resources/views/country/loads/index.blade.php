...
<div class="space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Country Loads Management</h1>
            <p class="mt-1 text-sm text-gray-500">Monitor and track freight loads in {{ Auth::user()->country->name ?? 'your country' }}</p>
        </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-4">
        <form method="GET" action="{{ route('country.loads.index') }}" class="space-y-4">
            ...
            <div class="flex flex-wrap gap-3 items-center">
                ...
                @if(request()->hasAny(['search', 'status', 'cargo_type', 'pricing_type', 'origin_city', 'destination_city', 'date_range', 'sort_by']))
                    <a href="{{ route('country.loads.index') }}" class="inline-flex items-center gap-2 px-4 py-2.5 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 font-medium">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="{{ route('country.loads.show', $load->id) }}" class="p-2 text-gray-600 rounded-lg hover:bg-blue-50 hover:text-blue-600" title="View">
                        ...
                        <tr>
                            <td colspan="9" class="px-6 py-20 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-sm text-gray-500">Freight loads from your country will appear here</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
