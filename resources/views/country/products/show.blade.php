    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between no-print">
        <div>
            <div class="flex items-center gap-3 mb-2">
                <a href="{{ route('country.products.index') }}" class="text-gray-600 hover:text-gray-900 transition-colors">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                ...
                <div class="space-y-4">
                    <div class="flex items-center gap-3">
                        <div class="flex items-center justify-center w-12 h-12 bg-purple-100 to-purple-200 rounded-full">
            ...
            <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6 no-print">
                ...
                <div class="space-y-2">
                    @if(!$product->is_admin_verified)
                        <form action="{{ route('country.products.approve', $product->id) }}" method="POST">
                            @csrf
                        ...
                        <form action="{{ route('country.products.reject', $product->id) }}" method="POST">
                            @csrf
                    ...
                    @endif
                    <form action="{{ route('country.products.destroy', $product->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this product?')">
                        @csrf
                        @method('DELETE')
