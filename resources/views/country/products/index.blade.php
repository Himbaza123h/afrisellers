...
<div class="space-y-6">
    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Country Products Management</h1>
            <p class="mt-1 text-sm text-gray-500">Monitor and manage products in {{ $country->name }}</p>
        </div>
                ...
                <div class="flex-1">
                    ...
                    <div class="mt-3 flex items-center gap-1">
                        <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                            <i class="fas fa-box mr-1 text-[10px]"></i> All products
                        </span>
                    </div>
                </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-4">
        <form method="GET" action="{{ route('country.products.index') }}" class="space-y-4">
            ...
            <div class="flex flex-wrap gap-3 items-center">
                ...
                @if(request()->hasAny(['search', 'date_range', 'status', 'verification', 'category', 'sort_by']))
                    <a href="{{ route('country.products.index') }}" class="inline-flex items-center gap-2 px-4 py-2.5 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 font-medium">
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div class="flex flex-col">
                                        <span class="text-sm font-semibold text-gray-900">{{ Str::limit($product->name, 30) }}</span>
                            ...
                            <td class="px-6 py-4">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="{{ route('country.products.show', $product->id) }}" class="p-2 text-gray-600 rounded-lg hover:bg-blue-50 hover:text-blue-600" title="View Details">
                                    ...
                                    @endif
                                    <form action="{{ route('country.products.destroy', $product->id) }}" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this product?')">
                                        @csrf
                                        @method('DELETE')
                        ...
                        <tr>
                            <td colspan="8" class="px-6 py-20 text-center">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-sm text-gray-500 mb-6">Products from your country will appear here</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
