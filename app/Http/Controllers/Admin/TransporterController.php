    ...
    public function verify(Transporter $transporter)
    {
        try {
            ...
            \App\Models\Notification::create([
                ...
                'content'   => 'Your transporter account has been verified by the admin. You can now accept delivery orders on AfriSellers.',
                'link_url'  => '/transporter/dashboard',
                'user_id'   => $transporter->user_id,
                'vendor_id' => null,
                'country_id'=> $transporter->country_id ?? null,
                'is_read'   => false,
            ]);
    ...
    public function unverify(Transporter $transporter)
    {
        ...
        $transporter->unverify();
            ...
            \App\Models\Notification::create([
                ...
                'content'   => 'Your transporter verification has been revoked by the admin. Please contact support for more information.',
                'link_url'  => null,
                'user_id'   => $transporter->user_id,
                'vendor_id' => null,
                'country_id'=> $transporter->country_id ?? null,
    ...
    public function activate(Transporter $transporter)
    {
        try {
            ...
            \App\Models\Notification::create([
                ...
                'content'   => 'Your transporter account has been activated. You can now start accepting delivery orders on AfriSellers.',
                'link_url'  => '/transporter/dashboard',
                'user_id'   => $transporter->user_id,
                'vendor_id' => null,
                'country_id'=> $transporter->country_id ?? null,
...
$transporter->suspend();
            ...
            \App\Models\Notification::create([
                ...
                'content'   => 'Your transporter account has been suspended. Please contact the admin team for assistance.',
                'link_url'  => null,
                'user_id'   => $transporter->user_id,
                'vendor_id' => null,
                'country_id'=> $transporter->country_id ?? null,
    ...
    public function destroy(Transporter $transporter)
    {
        ...
        if ($transporter->user_id) {
                \App\Models\Notification::create([
                    ...
                    'content'   => 'Your transporter account has been removed from AfriSellers. Contact support if you believe this is a mistake.',
                    'link_url'  => null,
                    'user_id'   => $transporter->user_id,
                    'vendor_id' => null,
                    'country_id'=> $transporter->country_id ?? null,
