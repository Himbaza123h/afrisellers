        ...
        try {
            ...
            if ($product->user_id) {
                \App\Models\Notification::create([
                    'title'     => $product->is_admin_verified ? 'Product Verified ✅' : 'Product Verification Revoked',
                    'content'   => $product->is_admin_verified
                        ? 'Your product "' . $product->name . '" has been verified by the admin and is now live on AfriSellers.'
                        : 'Your product "' . $product->name . '" verification has been revoked. Please review and resubmit.',
                    'link_url'  => '/vendor/products/' . $product->id,
                    'user_id'   => $product->user_id,
                    'vendor_id' => $product->user?->vendor?->id ?? null,
