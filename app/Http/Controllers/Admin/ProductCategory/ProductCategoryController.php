    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            \App\Models\Notification::create([
                ...
                'content'   => 'Category "' . $category->name . '" has been created successfully on AfriSellers.',
                'link_url'  => '/admin/product-categories/' . $category->id,
                'user_id'   => auth()->id(),
                'vendor_id' => null,
                'country_id'=> null,
                'is_read'   => false,
    ...
    public function update(Request $request, ProductCategory $productCategory)
    {
        ...
        try {
            ...
            \App\Models\Notification::create([
                ...
                'content'   => 'Category "' . $productCategory->name . '" has been updated successfully.',
                'link_url'  => '/admin/product-categories/' . $productCategory->id,
                'user_id'   => auth()->id(),
                'vendor_id' => null,
                'country_id'=> null,
                'is_read'   => false,
...
$categoryName = $productCategory->name;
            ...
            \App\Models\Notification::create([
                ...
                'content'   => 'Category "' . $categoryName . '" has been deleted from AfriSellers.',
                'link_url'  => '/admin/product-categories',
                'user_id'   => auth()->id(),
                'vendor_id' => null,
                'country_id'=> null,
                'is_read'   => false,
...
$productCategory->status = $productCategory->status === 'active' ? 'inactive' : 'active';
            ...
            \App\Models\Notification::create([
                ...
                'content'   => 'Category "' . $productCategory->name . '" has been ' . $productCategory->status . '.',
                'link_url'  => '/admin/product-categories/' . $productCategory->id,
                'user_id'   => auth()->id(),
                'vendor_id' => null,
                'country_id'=> null,
