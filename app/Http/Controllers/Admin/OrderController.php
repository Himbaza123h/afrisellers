...
$order->calculateTotals();
            ...
            \App\Models\Notification::create([
                ...
                'content'   => 'A new order #' . $order->order_number . ' has been placed and is awaiting your processing.',
                'link_url'  => '/vendor/orders/' . $order->id,
            ...
            \App\Models\Notification::create([
                ...
                'content'   => 'Your order #' . $order->order_number . ' has been placed successfully. We will notify you when it is confirmed.',
...
$order->calculateTotals();
            ...
            // Notify buyer and vendor of status change
            $statusMessages = [
                'confirmed'  => ['title' => 'Order Confirmed ✅',       'content' => 'Your order #' . $order->order_number . ' has been confirmed and is being prepared.'],
                'processing' => ['title' => 'Order Processing 🔄',      'content' => 'Your order #' . $order->order_number . ' is now being processed.'],
                'shipped'    => ['title' => 'Order Shipped 🚚',          'content' => 'Your order #' . $order->order_number . ' has been shipped and is on its way.'],
                'delivered'  => ['title' => 'Order Delivered 🎉',        'content' => 'Your order #' . $order->order_number . ' has been delivered successfully. Enjoy!'],
                'cancelled'  => ['title' => 'Order Cancelled',           'content' => 'Your order #' . $order->order_number . ' has been cancelled by the admin.'],
                'pending'    => ['title' => 'Order Set to Pending',      'content' => 'Your order #' . $order->order_number . ' has been set back to pending.'],
            ];

            if (isset($statusMessages[$validated['status']])) {
                $msg = $statusMessages[$validated['status']];
                ...
                if ($order->vendor_id) {
                    \App\Models\Notification::create([
                        ...
                        'content'   => 'Order #' . $order->order_number . ' status has been changed to ' . ucfirst($validated['status']) . ' by admin.',
                        'link_url'  => '/vendor/orders/' . $order->id,
...
// Notify buyer before deletion
            if ($order->buyer_id) {
                \App\Models\Notification::create([
                    'title'     => 'Order Removed',
                    'content'   => 'Your order #' . $order->order_number . ' has been removed by the admin. Contact support for more information.',
                    'link_url'  => null,
                    'user_id'   => $order->buyer_id,
                    'vendor_id' => null,
                    'country_id'=> null,
...
DB::commit();
            ...
            if ($order->buyer_id) {
                \App\Models\Notification::create([
                    ...
                    'content'   => 'Your order #' . $order->order_number . ' has been cancelled. Contact support if you have questions.',
                    'link_url'  => '/orders/' . $order->id,
                    'user_id'   => $order->buyer_id,
                    'vendor_id' => null,
                    'country_id'=> null,
            ...
            if ($order->vendor_id) {
                \App\Models\Notification::create([
                    'title'     => 'Order Cancelled',
                    'content'   => 'Order #' . $order->order_number . ' has been cancelled. Inventory has been restored.',
                    'link_url'  => '/vendor/orders/' . $order->id,
                    'user_id'   => $order->vendor_id,
                    'vendor_id' => null,
                    'country_id'=> null,
