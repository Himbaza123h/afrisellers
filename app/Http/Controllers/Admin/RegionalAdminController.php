...
public function store(Request $request)
{
    ...
    try {
        ...
        // Save location to region if provided
        if (!empty($validated['location'])) {
            $regionalAdmin->update(['location' => $validated['location']]);
        }

        DB::commit();

    // Notify the new regional admin
        \App\Models\Notification::create([
            'title'     => 'Welcome as Regional Administrator',
            'content'   => 'You have been assigned as Regional Administrator. You can now manage your region on AfriSellers.',
            'link_url'  => '/regional/dashboard',
            'user_id'   => $user->id,
            'vendor_id' => null,
            'country_id'=> null,
            'is_read'   => false,
...
public function switchToRegional(RegionalAdmin $regionalAdmin)
{
    ...
    public function update(Request $request, RegionalAdmin $regionalAdmin)
    {
        ...
        try {
            ...
            $regionalAdmin->update(['location' => $validated['location'] ?? null]);

            DB::commit();

                        // Notify the regional admin of profile update
            \App\Models\Notification::create([
                'title'     => 'Your Profile Was Updated',
                'content'   => 'Your regional administrator profile has been updated by the admin.',
                'link_url'  => '/regional/profile',
                'user_id'   => $regionalAdmin->user_id,
                'vendor_id' => null,
                'country_id'=> null,
                'is_read'   => false,
            ]);
    ...
    public function activate(RegionalAdmin $regionalAdmin)
    {
        try {
            ...
            \App\Models\Notification::create([
                ...
                'content'   => 'Your regional administrator account has been activated. You now have full access.',
                'link_url'  => '/regional/dashboard',
                'user_id'   => $regionalAdmin->user_id,
                'vendor_id' => null,
                'country_id'=> null,
    ...
    public function deactivate(RegionalAdmin $regionalAdmin)
    {
        try {
            ...
            \App\Models\Notification::create([
                ...
                'content'   => 'Your regional administrator account has been deactivated. Contact the admin for more information.',
                'link_url'  => null,
                'user_id'   => $regionalAdmin->user_id,
                'vendor_id' => null,
                'country_id'=> null,
    ...
    public function suspend(RegionalAdmin $regionalAdmin)
    {
        try {
            ...
            \App\Models\Notification::create([
                ...
                'content'   => 'Your regional administrator account has been suspended. Please contact the admin team for assistance.',
                'link_url'  => null,
                'user_id'   => $regionalAdmin->user_id,
                'vendor_id' => null,
                'country_id'=> null,
    ...
    public function assignRegionalUser(Request $request, RegionalAdmin $regionalAdmin)
    {
        ...
        try {
            ...
            $notifyUserId = $assignedUser ? $assignedUser->id : ($user->id ?? null);
            if ($notifyUserId) {
                \App\Models\Notification::create([
                    'title'     => $assignedUser ? 'Your Account Was Updated' : 'Regional Admin Account Created',
                    'content'   => $assignedUser
                        ? 'Your regional administrator account details have been updated by the admin.'
                        : 'Your regional administrator account has been created. You can now log in and manage your region.',
                    'link_url'  => '/regional/dashboard',
