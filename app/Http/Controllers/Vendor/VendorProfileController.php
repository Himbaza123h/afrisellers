...
class VendorProfileController extends Controller
{
    ...
    public function printSettings()
    {
        try {
            ...
            return view('vendor.store.print', compact('vendor', 'stats'));
        } catch (\Exception $e) {
            Log::error('Vendor Store Print Error: ' . $e->getMessage());
            return redirect()->back()->with('error', 'An error occurred while loading the print view.');
        }
    }
