...
class Vendor extends Model
{
    ...
    protected $fillable = ['user_id','agent_id', 'business_profile_id', 'owner_id_document_id', 'plan_id', 'email_verification_token', 'email_verified_at', 'account_status', 'email_verified'];
...
// Scope: only vendors belonging to a given agent
public function scopeForAgent($query, $agentId)
{
    ...
    /**
     * Supplier-type add-ons store business_profiles.id in addon_users.supplier_id.
     */
    public function addonUsers()
    {
        return $this->hasMany(AddonUser::class, 'supplier_id', 'business_profile_id');
    }
