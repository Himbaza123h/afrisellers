...
class Product extends Model
{
    ...
    protected $fillable = ['user_id', 'video_url', 'country_id', 'product_category_id', 'is_lower_priced', 'views', 'name', 'slug', 'description', 'short_description', 'min_order_quantity', 'is_negotiable', 'overview', 'specifications', 'status', 'is_admin_verified'];
