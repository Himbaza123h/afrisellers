...
{
    return $this->hasOne(\App\Models\AgentSetting::class);
}

public function getAgentSettings()
{
    return $this->agentSettings ?? AgentSetting::create(['user_id' => $this->id]);
}
...
{
    return $this->belongsToMany(MessageGroup::class, 'message_group_members', 'user_id', 'group_id')
